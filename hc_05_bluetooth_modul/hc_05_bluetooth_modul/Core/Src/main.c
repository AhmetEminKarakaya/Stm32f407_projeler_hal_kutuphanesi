...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  HAL_UART_Receive(&huart2, (uint8_t*)rx_buffer, 6, 100);
	  ...
	  else if(rx_buffer[0] == 'l' && rx_buffer[1] == 'e' && rx_buffer[2] == 'd' && rx_buffer[3] == ' ' && rx_buffer[4] == 'o' && rx_buffer[5] == 'f' )
	  {
